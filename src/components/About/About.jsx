...
const About = () => {
  ...
  return (
    <section id="about">
      ...
      <br />
      <p>I always strive to complete work to the highest quality I can achieve, with great attention to detail.
        <br /> I believe in maintaining constant communication with my clients to achieve the best results.
      </p>
